...
export default defineMcp({
  ...
  version: "0.1.0",
  instructions:
    "Ferramentas para sacoleiras da Aura Store: consultar sua loja, produtos, pedidos e rede MLM. Todas as ferramentas operam apenas sobre os dados da sacoleira autenticada (respeita RLS).",
